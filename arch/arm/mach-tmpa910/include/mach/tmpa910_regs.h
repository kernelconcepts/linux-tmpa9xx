...
#define	TIMER1_BGLOAD		__REG(TIME1_BASE_ADDRESS + 0x0018)
#define	TIMER1_COMPARE_1	__REG(TIME1_BASE_ADDRESS + 0x00A0)
#define	TIMER1_CMPINTCLR_1	__REG(TIME1_BASE_ADDRESS + 0x00C0)
#define	TIMER1_CMPEN		__REG(TIME1_BASE_ADDRESS + 0x00E0)
#define	TIMER1_CMP_RIS		__REG(TIME1_BASE_ADDRESS + 0x00E4)
#define	TIMER1_CMP_MIS		__REG(TIME1_BASE_ADDRESS + 0x00E8)
...
#define	TIMER3_COMPARE_1	__REG(TIME3_BASE_ADDRESS + 0x00A0)
#define	TIMER3_CMPINTCLR_1	__REG(TIME3_BASE_ADDRESS + 0x00C0)
#define	TIMER3_CMPEN		__REG(TIME3_BASE_ADDRESS + 0x00E0)
#define	TIMER3_CMP_RIS		__REG(TIME3_BASE_ADDRESS + 0x00E4)
#define	TIMER3_CMP_MIS		__REG(TIME3_BASE_ADDRESS + 0x00E8)
...
#define	TIMER4_CMP_RIS		__REG(TIME4_BASE_ADDRESS + 0x00E4)
