...
static const char driver_name [] = "tmpa9xx_udc";
 ...
 */	
static int
write_ep0_fifo (struct tmpa9xx_ep *ep, struct tmpa9xx_request *req)
{
 ...
 */
static int
read_ep0_fifo (struct tmpa9xx_ep *ep, struct tmpa9xx_request *req)
{
...
tmpa9xx_ep_alloc_request(struct usb_ep *_ep, unsigned int gfp_flags)
{
...
static int tmpa9xx_ep_enable(struct usb_ep *_ep,
...
static int tmpa9xx_ep_queue(struct usb_ep *_ep,
...
// DMA
	...
	udc->dma_ch = tmpa910_dma_request("tmpa9xx UDC", 4, tmpa9xx_udc_dma_handler,
